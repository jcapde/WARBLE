...
def lowerbound(tn, ln, wnm, a_pi, pi_, en_,mk_, m_mu, betamuk_,beta_mu, nuk_, nu_Delta, Wk_, W_Delta,mtauk_, m_tau, betatauk_, beta_tau, ak_, a_lambda, bk_, b_lambda, thetak_,a_theta, znm_, Phi):
...
def inference_blei(It, tn, ln, wnm, a_pi, T, K, m_mu, beta_mu, W_Delta, nu_Delta, m_tau, beta_tau, a_lambda, b_lambda, a_theta, Phi):
    ...
    lwbound = lowerbound(tn, ln, wnm, a_pi, pi_, en_,mk_, m_mu, betamuk_,beta_mu, nuk_, nu_Delta, Wk_, W_Delta,mtauk_, m_tau, betatauk_, beta_tau, ak_, a_lambda, bk_, b_lambda, thetak_, a_theta, znm_, Phi)
