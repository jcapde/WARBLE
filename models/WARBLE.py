...
def lowerbound(values, bins, H, xedges, yedges, tn, ln, wnm, a_pi, pi_, en_,mk_, m_mu, betamuk_,beta_mu, nuk_, nu_Delta, Wk_, W_Delta,mtauk_, m_tau, betatauk_, beta_tau, ak_, a_lambda, bk_, b_lambda, thetak_, a_theta, znm_, phik_, a_phi):
...
def inference_wback(It, tn, ln, wnm, a_pi, T, K, m_mu, beta_mu, W_Delta, nu_Delta, m_tau, beta_tau, a_lambda, b_lambda, a_theta, a_phi,values, bins, H, xedges, yedges):
    ...
    it = 0
    lwbound_old = -1000.
    lwbound = lowerbound(values, bins, H, xedges, yedges, tn, ln, wnm, a_pi, pi_, en_,mk_, m_mu, betamuk_,beta_mu, nuk_, nu_Delta, Wk_, W_Delta,mtauk_, m_tau, betatauk_, beta_tau, ak_, a_lambda, bk_, b_lambda, thetak_, a_theta, znm_, phik_, a_phi)
